...
GOOD_FILE="ft_nmTester/test_file/good_files/"
BAD_FILE="ft_nmTester/test_file/bad_files/"
MANDATORY_FILE="ft_nmTester/test_file/mandatory/"
TEST_BAD_FILE="ft_nmTester/test_file/test_bad_file/"
PE_FILE="ft_nmTester/test_file/pe_file/"
...
source ft_nmTester/sh/valgrind_test.sh
source ft_nmTester/sh/exit_code.sh
...
basic_diff_test() {
	elf_file_diff ${BIN}
	elf_file_diff ft_nmTester/test_file/libft_malloc.so
	elf_file_diff libft/ft_atoi.o
	elf_file_diff ft_nmTester/test_file/debug_sym.o
	elf_file_diff ft_nmTester/test_file/mandatory/test_facile
...
do_test() {
	...
	multiple_file_diff ft_nm ft_nmTester/test_file/libft_malloc.so libft/ft_atoi.o ft_nmTester/test_file/debug_sym.o
	multiple_file_diff ft_nm ft_nmTester/test_file/libft_malloc.so libft/ft_atoi.o dasdas ft_nm
